...
public class Control {
    ...
    private static void initializeAdrArbitrageXSGO(){
        ...
        try {
            ...
            com.larrainvial.logviwer.controller.adrarbitragexsgo.DolarController controller = algo.getMkd_dolar_loader().getController();
    ...
    private static void initializeAdrArbitrageXTSE(){
        ...
        try {
            ...
            algo.getMkd_dolar_loader().setLocation(MainApp.class.getResource("view/adrarbitragextse/MKD_DOLAR.fxml"));
            algo.getMkd_adr_loader().setLocation(MainApp.class.getResource("view/adrarbitragextse/MKD_NYSE.fxml"));
            algo.getMkd_local_loader().setLocation(MainApp.class.getResource("view/adrarbitragextse/MKD_XSGO.fxml"));
            algo.getRouting_adr_loader().setLocation(MainApp.class.getResource("view/adrarbitragextse/ROUTING_ADR.fxml"));
            algo.getRouting_local_loader().setLocation(MainApp.class.getResource("view/adrarbitragextse/ROUTING_XSGO.fxml"));
            ...
            com.larrainvial.logviwer.controller.adrarbitragextse.DolarController controller = algo.getMkd_dolar_loader().getController();
            algo.setMkd_dolar_tableView(controller.getType());
            algo.setDolarMasterList(controller.masterData);
            algo.setDolarFilterList(controller.filteredData);

            com.larrainvial.logviwer.controller.adrarbitragextse.AdrMKDController getMkd_adr_loader = algo.getMkd_adr_loader().getController();
            algo.setMkd_adr_tableView(getMkd_adr_loader.getType());
            algo.setMkdAdrMasterList(getMkd_adr_loader.masterData);
            algo.setMkdAdrFilterList(getMkd_adr_loader.filteredData);

            com.larrainvial.logviwer.controller.adrarbitragextse.LocalMKDController getMkd_local_loader = algo.getMkd_local_loader().getController();
            algo.setMkd_local_tableView(getMkd_local_loader.getType());
            algo.setMkdLocalMasterList(getMkd_local_loader.masterData);
            algo.setMkdLocalFilterList(getMkd_local_loader.filteredData);

            com.larrainvial.logviwer.controller.adrarbitragextse.AdrRoutingController routing_adr_loader = algo.getRouting_adr_loader().getController();
            algo.setRouting_adr_tableView(routing_adr_loader.getType());
            algo.setRoutingAdrMasterList(routing_adr_loader.masterData);
            algo.setRoutingAdrFilterList(routing_adr_loader.filteredData);

            com.larrainvial.logviwer.controller.adrarbitragextse.LocalRoutingController routing_local_loader = algo.getRouting_local_loader().getController();
            algo.setRouting_local_tableView(routing_local_loader.getType());
            algo.setRoutingLocalMasterList(routing_local_loader.masterData);
            algo.setRoutingLocalFilterList(routing_local_loader.filteredData);
