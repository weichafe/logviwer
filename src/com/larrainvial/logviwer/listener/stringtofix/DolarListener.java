...
public class DolarListener extends Thread {
    ...
    public DolarListener(Algo algo, String message) {
        this.algo = algo;
    ...
    public synchronized void run(){
        ...
        try {
            ...
            AlertListener alertListener = new AlertListener(algo, modelMarketData, Constants.TypeMarket.DOLAR);
            alertListener.start();

            CalculateLastPriceListener calculateLastPriceListener = new CalculateLastPriceListener(algo, modelMarketData, Constants.TypeMarket.DOLAR);
